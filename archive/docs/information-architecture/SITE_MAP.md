...
### 頁面資訊
- **進入方式**：賽事詳情頁 → 點擊「雷達模式」按鈕
- **特殊要求**：需確認下載整場賽事數據 (100-300MB, 1-5分鐘)
- **主要功能**：追蹤整場賽事所有鴿子的飛行過程
...
| 按鈕 | 選擇器 | 功能 |
|------|--------|------|
| 展開/收起 | `button "勾选清单 N"` expandable | 切換面板顯示 |
| 刪除 | `button "删除"` | 移除單隻鴿子 |
| 全部刪除 | `button "全部删除"` | 清空勾選清單 |
