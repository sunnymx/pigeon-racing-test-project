...
| 記錄點 | 頁面/狀態 | 類型 | 優先級 | 測試項目數 |
|--------|----------|------|--------|-----------|
| **主流程** |||||
| #01 | 首頁 - 賽事列表 | 入口 | P0 | 4 |
| #02 | 賽事詳情 - 鴿子列表 | 核心 | P0 | 5 |
| #03 | 2D 靜態軌跡 + InfoWindow | 核心 | P0 | 6 |
| #04 | 2D 動態模式 + 風場 | 進階 | P1 | 7 |
| #05 | 3D 模式完整功能 | 核心 | P0 | 8 |
| #06 | 軌跡詳情 - 航點列表 | 核心 | P0 | 15 |
| **輔助功能** |||||
| #07 | 多選鴿子顯示 | 進階 | P1 | 4 |
| #08 | 鴿舍列表 Tab | 進階 | P1 | 5 |
| #09 | 勾選清單面板 | 輔助 | P2 | 5 |
